        ...
        <div className="flex max-w-3xl flex-col items-center lg:items-start gap-2 text-center">
          ...
          <div className="flex items-center gap-4 mt-16">
            <div className="flex flex-col gap-4">
              ...
              {/* ===== BOTÃO DE CURRÍCULO MODIFICADO ===== */}
              <a
                // O href aponta para o arquivo na pasta public
                href="/WilkerMartins_Curriculo.pdf"
                // O atributo 'download' instrui o navegador a baixar o arquivo
            ...
            <div className="flex flex-col items-center gap-4">
              <a
                // Lembre-se de adicionar seu link do GitHub aqui
              ...
              <a
                // Lembre-se de adicionar seu link do LinkedIn aqui
